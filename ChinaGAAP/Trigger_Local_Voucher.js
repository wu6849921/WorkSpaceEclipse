...
//nlapiLogExecution('debug', '前internalid查询条件+detailname', internalid+detailname);// add
			...
			//nlapiLogExecution('debug', '后internalid查询条件+detailname', internalid+detailname);// add
			// by
			// joe
			// 180105
