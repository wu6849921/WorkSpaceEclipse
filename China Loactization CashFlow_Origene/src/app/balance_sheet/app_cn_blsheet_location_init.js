 ...
 */
define(
		[ '../../dao/cn_location_dao', '../../lib/commons' ],
		function(locationDao, commons) {
			 ...
			 * @param {bool}
			 *            [isCreate] - initialize location from suitelet or not.
			 */
			function initLocation(field, defaultLocationId, subsidiaryId,
					isCreate) {
				if (!field) {
					return;
				}
				...
				for ( var i in rs) {
					...
					var isSelected = hasLocationId ? parseInt(defaultLocationId) === parseInt(internalid)
							: false;
