...
// log.debug('app_cn_cashflow_adapter.js: runStandardReports',
// alertfn);
        httpsGetPromise({
            ...
            var params = {
             ...
             // line 35, Effective of foreign exchange rate changes on cash
...
// log.debug('app_cn_cashflow_adapter.js: prepareRunStandardReportURL',
// form);
    	  try {
    		  var runStandardReportsURL = url.resolveScript({
    	            ...
    	            params: {
    	                ...
    	                // NSCHINA-2428
    	                // Add single selection for location/department/class on
						// China
    					// Cash Flow Page
...
// runStandardReportsURL);
    ...
    function subsidiaryChangeHandler(currentRecord, cacheInfor, alertfn) {
        ...
        // NSCHINA-2428
        // Update select options for location/department/field with subsidiary
		// change
