 ...
 */
define([
    '../../app/cashflow/app_cn_cashflow_filter',
    'N/record',
    '../../lib/commons',
    '../../lib/util'
],
...
function(filter, record, commons) {
    ...
    var api = {
        ...
        fieldChanged: function(scriptContext) {
            ...
            log.debug('cs_cn_cashflow_journal_filter', 'type=' + currentRec.type + ',id=' + currentRec.id);

            var sublistId = scriptContext.sublistId;
            var fieldId = scriptContext.fieldId;

            //Implement journal entry cfs item filter logic
            if (currentRec.type === record.Type.JOURNAL_ENTRY && sublistId === 'line' && (fieldId === 'credit' || fieldId === 'debit')) {
