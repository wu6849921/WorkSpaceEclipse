...
<pdf>
    ...
    <body size="A4-landscape" footer ="cbjlFooter">
    <#list data.body.pages as pages>

    <table id="cbjlstatement_data"  class="itemtable" style="page-break-after:always; width: 100%; margin-top: 10px;bottom: 1cm" cellspacing="0" cellpadding="2">
        <thead >
        ...
        <tr style="height: 25px;">
            ...
            <th align="center" rowspan="2" colspan="2" style="vertical-align: middle;" bgcolor="#999999"><#if .locale == "en_US">${data.body.columnDocumentNumberName?substring(0,8)}<br/>${data.body.columnDocumentNumberName?substring(8)}<#else>${data.body.columnDocumentNumberName}</#if></th>
            <th align="center" rowspan="2" colspan="2" style="vertical-align: middle;" bgcolor="#999999"><#if .locale == "en_US">${data.body.columnPaymentMethodName?substring(0,7)}<br/>${data.body.columnPaymentMethodName?substring(7)}<#else>${data.body.columnPaymentMethodName}</#if></th>
            <th align="center" rowspan="2" colspan="2" style="vertical-align: middle;" bgcolor="#999999">${data.body.columnGLNumberName}</th>
        ...
        <tr style="height: 25px;">
            <th align="center" colspan="2" style="vertical-align: middle; " bgcolor="#999999"><#if .locale == "en_US">${data.body.columnDirectionName?substring(0,6)}<br/>${data.body.columnDirectionName?substring(6)}<#else>${data.body.columnDirectionName}</#if></th>
           ...
           <#list pages.rows as line>
			    <tr>
                    ...
                    <td align="left" colspan="2" style="vertical-align: middle;"><#if istotal><b>${line.paymentMethod}</b><#else>${line.paymentMethod}</#if></td>
                    <td align="left" colspan="2" style="vertical-align: middle;"><#if istotal><b>${line.glNumber}</b><#else>${line.glNumber}</#if></td>
                    ...
                    <td align="left" colspan="2" style="vertical-align: middle;"><#if istotal><b>${line.balance.direction}</b><#else>${line.balance.direction}</#if></td>
