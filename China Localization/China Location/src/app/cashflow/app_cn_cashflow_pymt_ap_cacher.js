...
function(search, record) {
    ...
    /*
     * @desc check the param is too large or not .
     * @param {object} [params] - cashflow_params.
    ...
    /*
     * @desc cache the param to customerecord .
     * @param {object} [params] - params.
     * @return number the internal id of the saved record.
     */
    ...
    /*
     * @desc get the cache param from customerecord.
     * @param {String} [id] - internal id.
     * @return the cached param.
     */
    ...
    /*
     * @desc delete the useless cache record.
     * @param {String} [id] - internal id.
     * @return the result.
     */
