...
<head>
<style type="text/css">
table { <#if .locale == "zh_CN"> font-family:STSong, sans-serif; <#elseif
	.locale == "en_US"> font-family:Arial, sans-serif; <#else > font-family:Arial,
	sans-serif; </#if >
