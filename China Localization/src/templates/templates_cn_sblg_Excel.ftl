...
table.body td {
	...
	<#function makesure value>
		...
		<!-- The sblg statement report will only take 65% of the screen width, and will not impact the exported PDF report width -->
		<table width="100%">
			<tr>
				<td>
					<table id="sblgstatement_header" class="header"
						style="width: 100%;">
						<tr>
                        ...
                        <tr>
                            ...
                            <td colspan="4" align="center">${data.date.from.value}&nbsp;-&nbsp;${data.date.to.value}</td>
			...
			<tr>
				<td>
					<table id="sblgstatement_data" class="itemtable"
						...
						<tr style="height: 25px;">
							...
							<th width="20%" align="center" colspan='2' style="text-align: center;"
