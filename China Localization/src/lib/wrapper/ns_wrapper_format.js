...
/**
 * This module is used to do various formatting. Please be aware that the date format is determined by system preference configured by user.
 * 
 * @param {format} format
...
function(formatter, commons, runtime) {
    ...
    /**
     * E.g.  parseDate('5/2/2017') -> Date
     *       parseDate('05/02/2017') -> Date
     * 
    ...
    /**
     * E.g.  parseDate('5/2/2017 8:16:27 pm') -> Date
     *       parseDate('05/02/2017 8:16:27 pm') -> Date
     *
     * @param Date as a string to parse.
     * @returns The parsed value as a Date
     */
    ...
    /**
     * E.g.  format(options) -> see SS2.0 API
     *       format({value: new Date(), pattern: 'yyyy-MM-dd hh:mm:ss'}) -> '2017-05-03 11:18:27'
     *       
     * @param options
     *          {options.value | required} Date to format.
     *          {options.type | required/optional} The type to be used to format date, see SS2.0 API.
     *          {options.pattern | optional/required} The pattern to be used to format date.
    ...
    /**
     * @desc Format currency value. 
     *       Format depends on user preference settings.
     * @param {Number} currency - Currency to format
    ...
    /**
     * @desc Parse string of currency to number format. This is based on user preference. E.g.  parseCurrency('12.34') -> 12.34
     * @param {String} currencyString - A string of currency to be parsed
    ...
    /**
     * @desc Returns the value of a number rounded to the nearest number. E.g.  round(12.345) -> 12.35
     * @param {Number} num - A number to be rounded
     * @return {Number} The value of the given number rounded to the nearest number.
     */
     ...
     * @param {Number} num
     * @param {Number} fixed  - specified number of decimal places
    ...
    /**
     * The toFixed() method formats a number using fixed-point notation. This should be equivalent to @function{roundToFixed}.
     *
     * @param {*} num - The numeric value to be formatted.
     * @param {Number} digits - Optional. The number of digits to appear after the decimal point; this may be a value between 0 and 20, inclusive, and implementations may optionally support a larger range of values. If this argument is omitted, it is treated as 0.
     * @returns {Number} A string representing the given number using fixed-point notation.
     */
    ...
    /**
     * @desc Returns the value of a number added zero. E.g.  addPerZero(.345) -> 0.35
     * @param {Number} num - A number added per zero
     ...
     * 
     * @params params.prefix prefix of filename.
     *         params.suffix suffix of filename.
    ...
    /**
     * @deprecated
     * format float data to fixed digit of num.
     *
     * if use original number 1.005, float number is like 1.004999999 then js 1.005.toFixed(2) result is 1.00
     * so use tricks +-0.000000001 to deal with decimal 4/5 round issue of js.
     * 
