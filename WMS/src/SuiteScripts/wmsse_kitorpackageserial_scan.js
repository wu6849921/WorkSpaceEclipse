					...
					if(getSerialNo!=null && getSerialNo!="" && getSerialNo!='null')
					{
						...
						else
						{
							try{
								...
								{
									updateOpenTask(soInternalId,coItemId,soLineno,Number(Big(enterQty).toFixed(5)),binInternalId,itemType
											,SOarray["custparam_whlocation"],'','','','',soInternalId
											...
											null,ordType,department,vclass,getPickreportid,null,invtStatus);
								...
								if(isItLastPick!=null && isItLastPick!='' && isItLastPick=="T")
								{
									...
									var mianItemOPenTaskid =	updateOpenTask(soInternalId,FetchedItemId,soLineno,
											...
											SOarray["custparam_cartonweight"],"F",trantype,SOarray["custparam_actualbegintime"],
											SOarray["custparam_customer"],'','','','','F','','','',vShipVia,null,ordType,department,vclass,
