...
function CheckInQty(request, response) {
    ...
    if (request.getMethod() == 'GET') {
        ...
        if (poLineDetails != null && poLineDetails != '' && poLineDetails.length > 0) {
            ...
            for (var x1 = 0; x1 < vColumnslist.length; x1++) {
                ...
                if (summaryLabel == 'Open Putaway Quantity') {
                    ...
                    // nlapiLogExecution('Debug', 'toshippedQTYIndex',
                    // toshippedQTYIndex);
                } else {
            ...
            for (var j = 0; j < poLineDetails.length; j++) {
                ...
                if (trantype != 'transferorder') vUnits = poLineDetails[j].getText(vColumnslist[unitsIndex]);
                ...
                if (vpoitemQty == null || vpoitemQty == '') vpoitemQty = 0;
                if (trantype == "returnauthorization") {
                    if (parseFloat(vpoitemQty) < 0) vpoitemQty = Big(vpoitemQty).mul( - 1);
                ...
                if (trantype == "transferorder") {
                    ...
                    if (inventoryStatusFeature == true && (itemType == "inventoryitem" || itemType == "assemblyitem" || itemType == "serializedinventoryitem" || itemType == "serializedassemblyitem")) {
                                ...
                                if (linktype == 'Item Fulfillment') {
                                    ...
                                    for (var f = 1; f <= fitemcount; f++) {
                                        ...
                                        if ((fitem == getItemInternalId) && (parseInt(getPOLineNo) == parseInt(pofline))) {
                                            ...
                                            // 'polinelength', polinelength);
                                            var compSubRecord = frecord.viewCurrentLineItemSubrecord('item', 'inventorydetail');

                                            var polinelength = 0;

                                            if (compSubRecord != null && compSubRecord != '' && compSubRecord != 'null') polinelength = compSubRecord.getLineItemCount('inventoryassignment');
                                            ...
                                            if (itemType == "inventoryitem" || itemType == "assemblyitem") {
                                                for (var j1 = 1; j1 <= polinelength; j1++) {
                                                    ...
                                                    // column.push(new
                                                    // nlobjSearchColumn('custrecord_wmsse_act_qty'));
                                                    ...
                                                    if (results != null && results != '') {
                                                        ...
                                                        for (var openTaskItr = 0; openTaskItr < results.length; openTaskItr++) {
                                                            ...
                                                            if (tempActQty == '' || tempActQty == null || tempActQty == undefined || isNaN(tempActQty)) tempActQty = 0;
                                                ...
                                                for (var j1 = 1; j1 <= polinelength; j1++) {
                                                    ...
                                                    // nlapiLogExecution('Debug',
                                                    // 'invtStatus,invtStatusTxt,serialNum',
                                                    // invtStatus+','+invtStatusTxt+','+serialNum);
                                                    var openTaskFilter = new Array();
                                                    openTaskFilter.push(new nlobjSearchFilter('custrecord_wmsse_sku', null, 'is', getItemInternalId));
                                                    openTaskFilter.push(new nlobjSearchFilter('custrecord_wmsse_order_no', null, 'is', poInternalId));
                                                    ...
                                                    openTaskFilter.push(new nlobjSearchFilter('custrecord_wmsse_wms_location', null, 'anyof', whLocation));
                                                    openTaskFilter.push(new nlobjSearchFilter('custrecord_wmsse_tasktype', null, 'anyof', [2]));
                                                    if (serialNum != null && serialNum != '') openTaskFilter.push(new nlobjSearchFilter('custrecord_wmsse_serial_no', null, 'anyof', serialNum));
                                                    ...
                                                    // nlapiLogExecution('DEBUG',
                                                    // 'statusRemQty,rcvQty,vtoStatusitemQty',statusRemQty+','+rcvQty+','+vtoStatusitemQty);
                                                    actQty = Big(actQty).plus(rcvQty);
                    ...
                    if (parseInt(vpoitemQty) == 0 || (itemType == "lotnumberedinventoryitem" || itemType == "lotnumberedassemblyitem")) {
                        ...
                        if (vConversionRate != null && vConversionRate != '' && vConversionRate != 'null' && vConversionRate != 'undefined') {
                            ...
                            if (transferOrderlotQty != null && transferOrderlotQty != '' && transferOrderlotQty != 'null' && transferOrderlotQty != 'undefined') {
                                ...
                                // columns.push(new
                                // nlobjSearchColumn('quantityshiprecv'));
                                ...
                                if (TOLineDetails != null && TOLineDetails != '' && TOLineDetails != 'null' && TOLineDetails.length > 0) {
                                    // nlapiLogExecution('Debug',
                                    // 'TOLineDetails', TOLineDetails.length);
                        ...
                        // nlapiLogExecution('Debug', 'NSfulfilledQty',
                        // vpoitemQty);
                    }
                }
                if (vpoitemRcvQty == null || vpoitemRcvQty == '') vpoitemRcvQty = 0;
                if (vpoitemNSRcvQty == null || vpoitemNSRcvQty == '') vpoitemNSRcvQty = 0;

                var totalReceivedQty = Number(Big(vpoitemRcvQty).plus(vpoitemNSRcvQty));
                // nlapiLogExecution('DEBUG', 'totalReceivedQty1',
                // totalReceivedQty);
        ...
        if (whLocation != null && whLocation != '' && getitemType != "noninventoryitem" && getitemType != "otherchargeitem" && getitemType != "serviceitem" && getitemType != "downloaditem" && getitemType != "giftcertificateitem") itemfilters.push(new nlobjSearchFilter('inventorylocation', null, 'anyof', whLocation));
        ...
        if (itemresults != null && itemresults != '') {
            ...
            for (var d = 0; d < itemresults.length; d++) {
                if (itemresults[d].getValue('preferredbin') == "T" && itemresults[d].getValue('location', 'binnumber') == whLocation) {
                    ...
                    // nlapiLogExecution('Debug', 'getPreferBinId',
                    // getPreferBinId);
            ...
            if (departments == true) Vdepartment = itemresults[0].getValue('department');
            if (classes == true) Vclass = itemresults[0].getValue('class');

            if (Vdepartment == null || Vdepartment == '' || Vdepartment == 'null' || Vdepartment == 'undefined' || Vclass == null || Vclass == '' || Vclass == 'null' || Vclass == 'undefined') {
        ...
        if (vUnits == '- None -' || vUnits == '' || vUnits == null) vUnits = '';
        ...
        if (trantype == 'transferorder') {
            ...
            if (inventoryStatusLst != null && inventoryStatusLst != "") {
                if (makeInvAvailFlagFromSelect == null || makeInvAvailFlagFromSelect == "") makeInvAvailFlagFromSelect = inventoryStatusLst[0][1];
            }

        }

        var tableHeaderText = 'Staging Bin Locations';
        if ((systemRule == null || systemRule == '' || systemRule == 'N') && (itemType != "noninventoryitem" && itemType != "otherchargeitem" && itemType != "serviceitem" && itemType != "downloaditem" && itemType != "giftcertificateitem")) {
            vBinDetails = fnGetPutBinAndIntDetails(getItemInternalId, strItemGrp, strItemFam, blnMixItem, blnMixLot, getPreferBin, whLocation, itemType, lotno, Vdepartment, Vclass, strvUnits, makeInvAvailFlagFromSelect, null, null, vClissification);
            tableHeaderText = 'Bin Locations';
        } else if (itemType != "noninventoryitem" && itemType != "otherchargeitem" && itemType != "serviceitem" && itemType != "downloaditem" && itemType != "giftcertificateitem") {
            vBinDetails = fnGetPutBinDetailsNew(getItemInternalId, strItemGrp, strItemFam, blnMixItem, blnMixLot, getPreferBin, whLocation, itemType, lotno, getPreferBinId);
        }
        ...
        if (Backordered == null || Backordered == '' || Backordered == 'null' || Backordered == 'undefined') Backordered = 0;

        if (YetToBePicked == null || YetToBePicked == '' || YetToBePicked == 'null' || YetToBePicked == 'undefined') YetToBePicked = 0;

        var errMsg = '';
        if (request.getParameter('custparam_error') != null && request.getParameter('custparam_error') != '') {
            errMsg = request.getParameter('custparam_error');
            if ((errMsg == "Please configure stage locations" || errMsg == "Please configure bin locations" || errMsg == "Please configure put strategies/bin locations") && ((vBinDetails.length != null && vBinDetails.length > 0) || (getPreferBin != null && getPreferBin != 'null' && getPreferBin != '' && getPreferBin != 'undefined' && systemRule == 'N'))) {
                errMsg = '';
            }
        }
        if (CSSfilefound) {
        ...
        // Ends here
        var html = "<!DOCTYPE HTML PUBLIC '-//W3C//DTD HTML 4.01//EN' 'http://www.w3.org/TR/html4/strict.dtd'>" + "<html><head><title>" + st0 + "</title>" + "<meta name='viewport' content='width=device-width, height=device-height, initial-scale=1.0'>" + "<meta http-equiv='X-UA-Compatible' content='IE=9' />";

        if (CSSurl != null && CSSurl != '') html = html + "<link href='" + CSSurl + "' type='text/css' rel='stylesheet'>";
        else html = html + "<link href='" + nlapiEscapeXML("https://system.na1.netsuite.com/c.TSTDRV909212/suitebundle19241/NS_common.css") + "' type='text/css' rel='stylesheet'>";

        if (JSSurl != null && JSSurl != '') {
            html = html + "<script type='text/javascript' src='" + JSSurl + "'></script>";
        }

        html = html + "<script type='text/javascript'>function DisplayBin_poInbound(val) {var reWhiteSpace ='';var selecteduomqtyArr = new Array();var enteredQty =0;" + "var ConvertQty=document.getElementById('hdnvConversionRate').value;var pooveragecheck = document.getElementById('hdnvPOoverageChecked').value; var remainingqty=parseFloat(document.getElementById('hdnItemRemQty').value);var uomTbl = document.getElementById('tblUOM');" + "if(uomTbl != null && uomTbl != '' && uomTbl != 'null' && uomTbl != 'undefined'){var rowcount = uomTbl.rows.length;" + "for(var r=0;r<rowcount;r++){var qty =document.getElementById('tblUOM').rows[r].cells[0].childNodes[0].value;if(qty==''){" + "document.getElementById('div_error').innerHTML ='Please enter qty';" + "document.getElementById('tblUOM').rows[r].cells[0].childNodes[0].focus();return false;}" + "else {if(isNaN(qty) || qty <= 0 ){document.getElementById('div_error').innerHTML ='Please enter valid qty ';document.getElementById('tblUOM').rows[r].cells[0].childNodes[0].focus();return false;}}" + "var qtyValidate = document.getElementById('tblUOM').rows[r].cells[0].childNodes[0].value.split('.');" + "if(qtyValidate.length > 1){if(parseInt(qtyValidate[1].length) > 5){document.getElementById('div_error').innerHTML ='Quantity can not have more than 5 decimal places.';document.getElementById('tblUOM').rows[r].cells[0].childNodes[0].focus();return false;}}" + "var uom =document.getElementById('tblUOM').rows[r].cells[2].childNodes[0].value;" + "if(uom==''){document.getElementById('div_error').innerHTML ='Please enter uom';" + "document.getElementById('tblUOM').rows[r].cells[2].childNodes[0].focus();return false;}var uomqtyStr = qty+'_'+uom;selecteduomqtyArr.push(uomqtyStr);" + "enteredQty = parseFloat(enteredQty)+(parseFloat(qty)*parseFloat(uom));}document.getElementById('hdnselecteduomswithqty').value=selecteduomqtyArr;" + "enteredQty =parseFloat(enteredQty)/parseFloat(ConvertQty);document.getElementById('hdntotaluomqtyentered').value = enteredQty;qty=enteredQty;}else{" + "var qty = document.getElementById('txtqty').value; " + "reWhiteSpace = qty.indexOf(' ') >= 0;" + "var qtyValidate = document.getElementById('txtqty').value.split('.');" + "if(qtyValidate.length > 1){if(parseInt(qtyValidate[1].length) > 5){document.getElementById('div_error').innerHTML ='Quantity can not have more than 5 decimal places.';document.getElementById('txtqty').focus();return false;}}}" + " var isactiveflag=document.getElementById('hdnisactiveflag').value;if(isactiveflag == 'F'){" + "document.getElementById('div_error').innerHTML ='Entered item is inactive';return false;} " + " var itemtype=document.getElementById('hdnitemtype').value; if(qty ==''){" + "document.getElementById('div_error').innerHTML ='Please enter qty';document.getElementById('txtqty').focus();return false;}else if(isNaN(qty) || parseFloat(qty)<=0 || (reWhiteSpace == true)){" + "document.getElementById('div_error').innerHTML ='Please enter valid qty';document.getElementById('txtqty').focus();return false;" + "}else if((parseFloat(qty)>parseFloat(remainingqty)) && pooveragecheck=='F'){ document.getElementById('div_error').innerHTML ='Overage receiving is not allowed';" + "if(uomTbl == null || uomTbl == '' || uomTbl == 'null' || uomTbl == 'undefined'){document.getElementById('txtqty').focus();}" + "else{var uomTbl = document.getElementById('tblUOM');var trowcount = uomTbl.rows.length;var indx = parseInt(trowcount)-1;document.getElementById('tblUOM').rows[indx].cells[0].childNodes[0].focus();return false;}" + "return false;}" + "else if(itemtype == 'serializedinventoryitem' || itemtype == 'serializedassemblyitem'){ " + " var ConvertQty=document.getElementById('hdnvConversionRate').value; var conversionQty=(qty)*(ConvertQty); " + "if(conversionQty.toString().indexOf('.') != -1){ document.getElementById('div_error').innerHTML ='Decimal qty is not allowed for serial item';if(uomTbl == null || uomTbl == '' || uomTbl == 'null' || uomTbl == 'undefined'){document.getElementById('txtqty').focus();}" + "else{var uomTbl = document.getElementById('tblUOM');var trowcount = uomTbl.rows.length;var indx = parseInt(trowcount)-1;document.getElementById('tblUOM').rows[indx].cells[0].childNodes[0].focus();}" + "return false; }document.getElementById('txtbin').value=val;document.forms['_rf_checkin_item'].submit();" + " document.getElementById('loading').style.display = ''; return true;}" + "document.getElementById('txtbin').value=val;document.forms['_rf_checkin_item'].submit();" + " document.getElementById('loading').style.display = ''; " + "return true; }</script>" +

        "	<script type='text/javascript'>function validateForm_poInbound() {var selecteduomqtyArr = new Array();" + "var pooveragecheck = document.getElementById('hdnvPOoverageChecked').value; var ConvertQty=document.getElementById('hdnvConversionRate').value;" + "var isactiveflag=document.getElementById('hdnisactiveflag').value;if(isactiveflag == 'F'){" + "document.getElementById('div_error').innerHTML ='Entered item is inactive';return false;} if(document.getElementById('hdnqtyCheckFlag').value == 'F'){" + "document.getElementById('div_error').innerHTML ='RCRD_HAS_BEEN_CHANGED : This order/order line has been changed';return false;" + "} if(document.getElementById('hdnusedBins').value == 'F'){document.getElementById('div_error').innerHTML ='Please select use bins flag for this item';return false;" + "}" + "var uomTbl = document.getElementById('tblUOM');var enteredQty =0; if(uomTbl != null && uomTbl != '' && uomTbl != 'null' && uomTbl != 'undefined'){" + "var rowcount = uomTbl.rows.length;for(var r=0;r<rowcount;r++){var qty =document.getElementById('tblUOM').rows[r].cells[0].childNodes[0].value;if(qty==''){" + "document.getElementById('div_error').innerHTML ='Please enter qty';document.getElementById('tblUOM').rows[r].cells[0].childNodes[0].focus();return false;" + "}else {if(isNaN(qty) || parseFloat(qty)<=0){" + "document.getElementById('div_error').innerHTML ='Please enter valid qty';" + "document.getElementById('tblUOM').rows[r].cells[0].childNodes[0].focus();return false;}}" + "var uom =document.getElementById('tblUOM').rows[r].cells[2].childNodes[0].value;if(uom==''){document.getElementById('div_error').innerHTML ='Please enter uom';" + "document.getElementById('tblUOM').rows[r].cells[2].childNodes[0].focus();return false;}var uomqtyStr = qty+'_'+uom;selecteduomqtyArr.push(uomqtyStr); " + "enteredQty = parseFloat(enteredQty)+(parseFloat(qty)*parseFloat(uom)); " + "var qtyValidate = qty.split('.');" + "if(qtyValidate.length > 1){if(parseInt(qtyValidate[1].length) > 5){document.getElementById('div_error').innerHTML ='Quantity can not have more than 5 decimal places.';document.getElementById('tblUOM').rows[r].cells[0].childNodes[0].focus();return false;}}" + "}document.getElementById('hdnselecteduomswithqty').value=selecteduomqtyArr;" + "enteredQty =parseFloat(enteredQty)/parseFloat(ConvertQty);var scannedqty=enteredQty;}" + "else{enteredQty = document.getElementById('txtqty').value;" + "var qtyValidate = document.getElementById('txtqty').value.split('.');" + "if(qtyValidate.length > 1){if(parseInt(qtyValidate[1].length) > 5){document.getElementById('div_error').innerHTML ='Quantity can not have more than 5 decimal places.';document.getElementById('txtqty').focus();return false;}}" + "}if(enteredQty == ''){" + "document.getElementById('div_error').innerHTML ='Please enter qty';" + "if(uomTbl == null || uomTbl == '' || uomTbl == 'null' || uomTbl == 'undefined'){document.getElementById('txtqty').focus();}return false;}else{var scannedqty=enteredQty;" + "var remainingqty=parseFloat(document.getElementById('hdnItemRemQty').value);  if((isNaN(scannedqty) || parseFloat(scannedqty)<=0)  ){" + "document.getElementById('div_error').innerHTML ='Please enter valid qty';" + "if(uomTbl == null || uomTbl == '' || uomTbl == 'null' || uomTbl == 'undefined'){document.getElementById('txtqty').focus();" + "}return false;" + "} if((parseFloat(scannedqty)>parseFloat(remainingqty)) && pooveragecheck=='F'){ document.getElementById('div_error').innerHTML ='Overage receiving is not allowed';" + "if(uomTbl == null || uomTbl == '' || uomTbl == 'null' || uomTbl == 'undefined'){document.getElementById('txtqty').focus();}" + "else{var uomTbl = document.getElementById('tblUOM');var trowcount = uomTbl.rows.length;var indx = parseInt(trowcount)-1;document.getElementById('tblUOM').rows[indx].cells[0].childNodes[0].focus();return false;}" + "return false;} var itemtype=document.getElementById('hdnitemtype').value; if(itemtype == 'serializedinventoryitem' || itemtype == 'serializedassemblyitem'){" + "  var conversionQty=(enteredQty)*(ConvertQty); if(conversionQty.toString().indexOf('.') > 0){" + " document.getElementById('div_error').innerHTML ='Decimal qty is not allowed for serial item';if(uomTbl == null || uomTbl == '' || uomTbl == 'null' || uomTbl == 'undefined'){document.getElementById('txtqty').focus();}" + "else{var uomTbl = document.getElementById('tblUOM');var trowcount = uomTbl.rows.length;var indx = parseInt(trowcount)-1;document.getElementById('tblUOM').rows[indx].cells[0].childNodes[0].focus();}return false;" + " }} if(document.getElementById('txtbin').value == '' && (document.getElementById('hdnPreferBin').value == '')){" + "document.getElementById('div_error').innerHTML ='Please enter/scan bin location'; document.getElementById('txtbin').focus();return false;}  else{" + "var sessionObj = document.getElementById('hdnsession').value;if(sessionObj != '' && sessionObj != null){" + "document.getElementById('div_error').innerHTML ='Transcation is in progress...';return false;}else{" + "document.getElementById('hdntotaluomqtyentered').value = enteredQty;document.getElementById('hdnsession').value = 'session';" + "document.getElementById('loading').style.display = ''; return true;}}}}</script>";
        html = html + functionkeyHtml;
        html = html + "<script type = 'text/javascript' >function preventBack(){window.history.forward();}setTimeout('preventBack()', 0);" + "window.onunload=function(){null};</script> </head><body  onkeydown='return OnKeyDown_CL();'>";
        html = html + "	<form name='_rf_checkin_item' id='_rf_checkin_item' method='POST'><input name='cmdSend1' class='defaultlink'   type='submit' value='' onclick='return validateForm_poInbound();' />" + // onkeydown='return
        // OnKeyDown_CL()'
        // >";
        "<div id='loading' style='display:none;'>" + "<img id='loading-image' src='" + imgUrl + "' class='centerImage' alt='Processing Please Wait....' background:none></img></div>" + "		<table width='100%'>" + "		<tr><td class='tableheading'>Receiving Qty</td></tr>" + "			<tr><td class='labelmsg'><div id='div_error'  style='color:red;display:block;' >" + errMsg + "</div></td></tr>" + "		<tr><td></td></tr><tr><td></td></tr></table>" + "		<table>" + "			<tr>" + "				<td align = 'left' class='labelmsg'>" + orderType + "#: <label>" + getPONo + "</label></td>" + "			</tr>" + "			<tr>" + "				<td align = 'left' class='labelmsg'>Item: <label>" + getPOItem + "</label>" + "				<input type='hidden' name='hdnActualBeginDate' value=" + getActualBeginDate + ">" + "				<input type='hidden' name='hdnActualBeginTime' value='" + getActualBeginTime + "'>" + "				<input type='hidden' name='hdnCustomer' value=" + customer + ">" + "				<input type='hidden' name='hdnActualBeginTimeAMPM' value=" + getActualBeginTimeAMPM + ">" + "				<input type='hidden' name='hdnWhLocation' value=" + whLocation + ">" + "				<input type='hidden' name='hdnWhCompany' value=" + whCompany + ">" + "				<input type='hidden' name='hdntrantype' value=" + trantype + ">" + "				<input type='hidden' name='hdnordertype' value='" + orderType + "'>" + "				<input type='hidden' name='hdnitemtype' id='hdnitemtype' value=" + itemType + ">" + "				<input type='hidden' name='hdnItemRemQty' id='hdnItemRemQty' value=" + getItemRemQty + ">" + "				<input type='hidden' name='hdnItemRecQty' value=" + getItemRecQty + ">" + "				<input type='hidden' name='hdnBackordered' id='hdnBackordered' value=" + Backordered + ">" + "				<input type='hidden' name='hdnYetToBePicked' id='hdnYetToBePicked' value=" + YetToBePicked + ">" + "				<input type='hidden' name='hdngetLanguage' value=" + getLanguage + ">" + "				<input type='hidden' name='hdnPoInternalId' value=" + getPOInternalId + ">" + "				<input type='hidden' name='hdnPoLineno' value=" + getPOLineNo + ">" + "				<input type='hidden' name='hdnItemInternalId' value=" + getItemInternalId + ">" + "				<input type='hidden' name='hdnPoItem' value='" + getPOItem + "'>" + "				<input type='hidden' name='hdnPreferBin' id='hdnPreferBin' value=" + getPreferBin + ">" + "				<input type='hidden' name='hdnlotno' value='" + lotno + "'>" + "				<input type='hidden' name='hdnlotexpirydate' value='" + lotExpiryDate + "'>" + "				<input type='hidden' name='hdnblnMixItem' value=" + blnMixItem + ">" + "				<input type='hidden' name='hdnblnMixLot' value=" + blnMixLot + ">" + "				<input type='hidden' name='hdnstrItemGrp' value=" + strItemGrp + ">" + "				<input type='hidden' name='hdnstrItemFam' value=" + strItemFam + ">" + "				<input type='hidden' name='hdnvPOoverageChecked' id='hdnvPOoverageChecked' value=" + vPOoverageChecked + ">" + "				<input type='hidden' name='hdnWhLocationName' value='" + whLocationName + "'>" + "				<input type='hidden' name='hdnusedBins' id='hdnusedBins' value=" + usedBins + ">" + "				<input type='hidden' name='hdnqtyCheckFlag' id='hdnqtyCheckFlag' value=" + qtyCheckFlag + ">" + "				<input type='hidden' name='hdngetStockConversionRate' id='hdngetStockConversionRate' value=" + getStockConversionRate + ">" + "				<input type='hidden' name='hdnuom' id='hdnuom' value=" + vUnits + ">" + "				<input type='hidden' name='hdnvConversionRate' id='hdnvConversionRate' value=" + vConversionRate + ">" + "				<input type='hidden' name='hdnisactiveflag' id='hdnisactiveflag' value=" + isactiveflag + ">" + "				<input type='hidden' name='hdnvporcvQty' id='hdnvporcvQty' value=" + vporcvQty + ">" + "				<input type='hidden' name='hdnvPoreminqty' id='hdnvPoreminqty' value=" + vPoreminqty + ">" + "				<input type='hidden' name='hdnsession' id='hdnsession'>" + "				<input type='hidden' name='hdntotaluomqtyentered' id='hdntotaluomqtyentered'>" + "				<input type='hidden' name='hdnselecteduomswithqty' id='hdnselecteduomswithqty' >" + "				<input type='hidden' name='hdntrnLotInvStatusIdStr' id='hdntrnLotInvStatusIdStr' value=" + trnLotInvStatusIdStr + ">" + "				<input type='hidden' name='hdntrnLotInvStatusTxtStr' id='hdntrnLotInvStatusTxtStr' value=" + trnLotInvStatusTxtStr + ">" + "				<input type='hidden' name='hdnvspecorder' value= '" + vSpecOrder + "'>" + "				<input type='hidden' name='hdnfromstatuschange' id='hdnfromstatuschange' >" + "				<input type='hidden' name='hdnbarcodecompstring' value='" + vbarcodecompstring + "'>" + "				<input type='hidden' name='hdncompositebarcode' value='" + vcompositebarcode + "'>" + "				</td>" + "			</tr>";
        ...
        html = html + "<tr>" + "				<td align = 'left' class='labelmsg'>Received Qty: <label>" + parseFloat(parseFloat(getItemRecQty).toFixed(5)) + " " + vUnits + "</label>" + "			</tr>" + "			<tr>" + "				<td align = 'left' class='labelmsg'>Remaining Qty: <label>" + parseFloat(parseFloat(getItemRemQty).toFixed(5)) + " " + vUnits + "</label>" + "			</tr>";
        html = html + "			<tr>" + "				<td align = 'left' class='labelmsg'>Yet To Be Picked Qty: <label>" + parseFloat(parseFloat(YetToBePicked).toFixed(5)) + " " + vUnits + "</label>" + "			</tr>" + "			<tr>" + "				<td align = 'left' class='labelmsg'>Back Ordered Qty: <label>" + Backordered + " " + vUnits + "</label>" + "			</tr>";
        ...
        if (results != null && results != '' && results.length > 0) {
            ...
            html = html + "			<tr>" + "				<td align = 'left'><input name='txtqty'  class='smalltextbox'  id='txtqty' type='text'/>";
            html = html + "			</tr>";
        ...
        if (inventoryStatusLst != null && inventoryStatusLst != '' && inventoryStatusLst != 'null' && inventoryStatusLst != 'undefined' && inventoryStatusLst.length > 0) {
            ...
            if (trantype == 'transferorder') {
                ...
                html = html + "</td></tr>";
                html = html + "			<tr><td>";
                // //using the above commented line, we can disable the select
                // field. but in this case,the option id is not passing to the
                // server(post part through request).
                ...
                if (itemType == "inventoryitem" || itemType == "assemblyitem" || itemType == "serializedinventoryitem" || itemType == "serializedassemblyitem") {
                    ...
                    if (trnLotInvStatusIdStr != null && trnLotInvStatusIdStr != '') {
                        ...
                        if (trnLotInvStatusTxtStr != null && trnLotInvStatusTxtStr != '') trnLotInvStatusTxtArr = trnLotInvStatusTxtStr.split(',');
        ...
        if (itemType == 'noninventoryitem' || itemType == 'otherchargeitem' || itemType == 'serviceitem' || itemType == 'downloaditem' || itemType == 'giftcertificateitem') {
            ...
            html = html + "			<tr>" + "				<td align = 'left' class='labelmsg'>Enter/Scan Bin Location" + "				</td>" + "			</tr>" + "			<tr>";
        ...
        "			<table><tr>" + "				<td align = 'left'></td><td>" + "					<input name='cmdPrevious' type='submit' value='Back (F7)'/>" + "				</td><td width='20px'></td>" + "				<td align = 'left'><input name='cmdSend' type='submit' value='" + btnText + "' onclick='return validateForm_poInbound();'/></td><td width='20px'></td><td>" + "			</tr></table>";
        // nlapiLogExecution('ERROR', 'vBinDetails', vBinDetails);
        // nlapiLogExecution('ERROR', 'errMsg', errMsg);
        if ((vBinDetails != null && vBinDetails != '' && vBinDetails.length != null) || (errMsg == "Please configure stage locations" || errMsg == "Please select use bins flag for this item" || errMsg == "RCRD_HAS_BEEN_CHANGED : This order/order line has been changed" || errMsg == "This item has mixflag false, please configure new bin locations" || errMsg == "Please configure bin locations" || errMsg == "Please configure put strategies/bin locations") || (getPreferBin != null && getPreferBin != 'null' && getPreferBin != '' && getPreferBin) != 'undefined' || (makeInvAvailFlagFromSelect != 'All' && makeInvAvailFlagFromSelect != null && makeInvAvailFlagFromSelect != 'null' && makeInvAvailFlagFromSelect != '' && makeInvAvailFlagFromSelect != 'undefined' && makeInvAvailFlagFromSelect != undefined)) {

            if (tableHeaderText == "Staging Bin Locations") {
                html = html + "	<table>" + " <tr>" + " <td>" + "	<table class='table'>" + " <tr class='uir-machine-headerrow'>" + " <td class='listheadertdleft listheadertextb uir-column-large' >" + tableHeaderText + "" + " </td>" + "</tr>";
                var vAltClass = '';
                for (var s = 0; s < vBinDetails.length; s++) {
                    if (s % 2 == 1) vAltClass = 'uir-list-row-tr line uir-list-row-even';
                    else vAltClass = 'uir-list-row-tr line uir-list-row-odd';
                    var txtBin = vBinDetails[s];
                    if (txtBin == getPreferBin && getPreferBinType == 'Stage') {
                        html = html + "	<tr class='" + vAltClass + "'>" + " <td><a  onclick='return DisplayBin_poInbound(\"" + txtBin + "\");' href='#' >" + txtBin + "</a><span style='color:red;'>* </span></td>" + "</tr>";
                        // case # 201412820 end
                    }
                    if (txtBin != getPreferBin) {
                        html = html + "	<tr class='" + vAltClass + "'>" + " <td><a onclick='return DisplayBin_poInbound(\"" + txtBin + "\");' href='#' >" + txtBin + "</a></td>" + "</tr>";
                    }
                    if (s >= 4) {
                        if (errMsg != '') {
                ...
                html = html + "			<tr class='uir-machine-headerrow' >" + "				<td>Bin Location" + "				</td>" + "				<td class='align-right'>Qty" + "				</td>";
                if (vUnits != null && vUnits != '' && vUnits != 'null' && vUnits != 'undefined' && vUnits != '- None -') {
                    html = html + "				<td></td>";
                ...
                if (getPreferBin != null && getPreferBin != '') {
                    ...
                    if (vqty == '' || vqty == null || vqty == 'undefined') vqty = 0;
                    // case # 201412820 start
                    html = html + "	<tr class='" + vAltClass + "'>" + " <td><a  onclick='return DisplayBin_poInbound(\"" + getPreferBin + "\");' href='#' >" + getPreferBin + "</a><span style='color:red;'>* </span></td>" + "				<td class='align-right' >" + parseFloat(parseFloat(vqty).toFixed(5)) + "" + "				</td>";
                    if (vUnits != null && vUnits != '' && vUnits != 'null' && vUnits != 'undefined' && vUnits != '- None -') {
                ...
                for (var st = 0; st < vBinDetails.length; st++) {
                    if (st % 2 == 1) vAltClass = 'uir-list-row-tr line uir-list-row-even';
                    else vAltClass = 'uir-list-row-tr line uir-list-row-odd';
                    ...
                    if (getPreferBin != txtBin) {
                        // case # 201412820 start
                        html = html + "			<tr class='" + vAltClass + "'>" + "<td><a  onclick='return DisplayBin_poInbound(\"" + txtBin + "\");' href='#' >" + txtBin + "</a>" + "				</td>" + "				<td class='align-right'>" + parseFloat(parseFloat(qty).toFixed(5)) + "" + "				</td>";
                        if (vUnits != null && vUnits != '' && vUnits != 'null' && vUnits != 'undefined' && vUnits != '- None -') {
                    ...
                    if (getPreferBin == null || getPreferBin == 'null' || getPreferBin == '' || getPreferBin == undefined) {
                        if (parseInt(st) >= 4) break;
                    } else {
                        if (parseInt(st) >= 3) break;
                    }
        ...
        if (vConversionRate != null && vConversionRate != '' && vConversionRate != 'null' && vConversionRate != 'undefined' && enterQty != null && enterQty != '' && enterQty != 'null' && enterQty != 'undefined') {
        ...
        if (sessionobj != context.getUser()) {
            try {
                ...
                if (optedEvent != 'Back (F7)') {
                    ...
                    // Code to navigate to the same screnn when status is
                    // changed.
                    ...
                    if (enterQty != null && enterQty != "" && enterQty != 'null' && !isNaN(enterQty) && ((parseFloat(remQty) >= parseFloat(enterQty)) || poOverageCheck == "T")) {
                        try {
                            ...
                            if ((trantype == 'transferorder')) {
                                ...
                                if (poLineno != null && poLineno != 'null' && poLineno != undefined && poLineno != '') filts.push(new nlobjSearchFilter('line', null, 'equalto', (parseFloat(poLineno) - 1)));
                                ...
                                var filters = new Array();
                                var trecord = '';
                                if (poInternalId != null && poInternalId != 'null' && poInternalId != undefined && poInternalId != '') filters.push(new nlobjSearchFilter('internalid', null, 'is', poInternalId));
                                filters.push(new nlobjSearchFilter('formulatext', null, 'is', 'Shipping').setFormula("decode({type},'Transfer Order',{transactionlinetype},'Shipping')"));
                                filters.push(new nlobjSearchFilter('type', null, 'anyof', 'TrnfrOrd'));
                                if (poLineno != null && poLineno != 'null' && poLineno != undefined && poLineno != '') filters.push(new nlobjSearchFilter('line', null, 'equalto', (parseFloat(poLineno) - 1)));
                                        ...
                                        try {
                                            ...
                                            if (vitemfulfillmentid != null && vitemfulfillmentid != 'null' && vitemfulfillmentid != undefined && vitemfulfillmentid != '' && (parseInt(FetchedItemId) == (vitemfulfillmentitemid))) {
                                                ...
                                                for (var f = 1; f <= fitemcount; f++) {
                                                            ...
                                                            if (inventoryStatusFeature) {
                                                                if ((itemType == "serializedinventoryitem" || itemType == "serializedassemblyitem")) {
                                                                    ...
                                                                    if (parseInt(complinelength) > 0) {
                                                                        ...
                                                                        if (curInvStatus == vInvStatus_select && parseFloat(vSercount) >= parseFloat(convertedQty) && parseFloat(vSercount) >= parseFloat(enterQty) && useitemcostflag == 'F') {
                                                                    ...
                                                                    nlapiLogExecution('DEBUG', '((parseFloat(invSpecQty) == parseFloat(convertedQty)) || (parseFloat(invSpecQty) == parseFloat(enterQty)))', ((parseFloat(invSpecQty) == parseFloat(convertedQty)) || (parseFloat(invSpecQty) == parseFloat(enterQty))));
                                                                    nlapiLogExecution('DEBUG', 'Final result', curInvStatus == vInvStatus_select && ((parseFloat(invSpecQty) == parseFloat(convertedQty)) || (parseFloat(invSpecQty) == parseFloat(enterQty))));
                                                                    ...
                                                                    if (curInvStatus == vInvStatus_select && parseFloat(invSpecQty) >= parseFloat(convertedQty) && parseFloat(invSpecQty) >= parseFloat(enterQty) && useitemcostflag == 'F') {
                                                    ...
                                                    if (lotQtyFlag == 'T' || invQtyFlag == 'T') break;
                                                }
                            ...
                            POarray["custparam_itemtype"] = itemType;
                            POarray["custparam_enterQty"] = Number(Big(enterQty)); // since
                            // this
                            // is
                            // used
                            // in
                            ...
                            if (enterBin != null && enterBin != "") {
                                ...
                                if (systemRule == null || systemRule == '' || systemRule == 'N') {
                                    ...
                                    if (preferBin != enterBin) {
                                        ...
                                        if (whLocation != null && whLocation != '' && whLocation != 'null' && whLocation != 'undefined') filter.push(new nlobjSearchFilter('location', null, 'anyof', whLocation));
                                        var searchrecord = nlapiSearchRecord('Bin', null, filter, null);
                                        if (searchrecord != null && searchrecord != "") binInternalId = searchrecord[0].getId();
                                    ...
                                    if ((enterBin != preferBin) && (itemType != 'noninventoryitem' && itemType != 'otherchargeitem' && itemType != 'serviceitem' && itemType != 'downloaditem' && itemType != 'giftcertificateitem')) {
                                        if (blnMixItem != "T") {
                                            ...
                                            if (FetchedItemId != null && FetchedItemId != '') filterStrat.push(new nlobjSearchFilter('internalid', null, 'noneof', FetchedItemId));
                                            if (POarray["custparam_whlocation"] != null && POarray["custparam_whlocation"] != '') filterStrat.push(new nlobjSearchFilter('location', 'binonhand', 'anyof', POarray["custparam_whlocation"]));
                                            if (binInternalId != null && binInternalId != '') filterStrat.push(new nlobjSearchFilter('binnumber', 'binonhand', 'anyof', binInternalId));
                                        ...
                                        if (blnMixLot != 'T' && (itemType == "lotnumberedinventoryitem" || itemType == "lotnumberedassemblyitem")) {
                                            ...
                                            if (POarray["custparam_whlocation"] != null && POarray["custparam_whlocation"] != '') filterStrat.push(new nlobjSearchFilter('location', 'inventoryNumberBinOnHand', 'anyof', POarray["custparam_whlocation"]));
                                            if (binInternalId != null && binInternalId != '') filterStrat.push(new nlobjSearchFilter('binnumber', 'inventoryNumberBinOnHand', 'anyof', binInternalId));
                                            if (blnMixLot != 'T' && lotno != null && lotno != '' && lotno != 'null' && lotno != 'undefined') filterStrat.push(new nlobjSearchFilter('inventorynumber', 'inventoryNumberBinOnHand', 'isnot', lotno));
                                    ...
                                    var filter = new Array();
                                    filter.push(new nlobjSearchFilter('binnumber', 'null', 'is', enterBin));
                                    if (POarray["custparam_whlocation"] != null && POarray["custparam_whlocation"] != '') filter.push(new nlobjSearchFilter('location', null, 'anyof', POarray["custparam_whlocation"]));
                                    filter.push(new nlobjSearchFilter('inactive', null, 'is', 'F'));
                                    var cols = new Array();
                            ...
                            if (itemType == "serializedinventoryitem" || itemType == "serializedassemblyitem") {
                                ...
                                // this is stop the duplicate entry of open task
                                // record when deffered item receipt rule is set
                                // to 'Y'
                                var tempflag = 'F';
                                ...
                                if (poitemLineDetails != null && poitemLineDetails != '' && poitemLineDetails.length > 0) {
                                    ...
                                    for (var j = 0; j < poitemLineDetails.length; j++) {
                                        ...
                                        if (trantype == "returnauthorization") {
                                            if (parseInt(vpoitemQty) < 0) vpoitemQty = Big(vpoitemQty).mul( - 1);
                                            nlapiLogExecution('DEBUG', 'vpoitemQty', vpoitemQty);
                                        ...
                                        if (parseFloat(vPoreminqty) < 0) vPoreminqty = 0;
                                ...
                                var itemReceipt = nswms_PostItemReceipt(trantype, poInternalId, FetchedItemId, poLineno, enterQty, binInternalId, itemType, POarray["custparam_whlocation"], lotno, lotExpiryDate, '', POarray["custparam_poid"], '', '', POarray["custparam_actualbegintime"], POarray["custparam_customer"], POarray["custparam_uom"], POarray["custparam_conversionrate"], fulfillmentIdArray, lineFullQty, useitemcostflag, vInvStatus_select, POarray["custparam_compbarcodestring"]);
...
function fnGetPutBinDetailsNew(getItemInternalId, strItemGrp, strItemFam, blnMixItem, blnMixLot, getPreferBin, strLocation, itemType, lotno, getPreferBinId) {
    var strMsg = "getItemInternalId : " + getItemInternalId + "<br>" + "strItemGrp : " + strItemGrp + "<br>" + "strItemFam : " + strItemFam + "<br>" + "blnMixItem : " + blnMixItem + "<br>" + "blnMixLot : " + blnMixLot + "<br>" + "getPreferBin : " + getPreferBin + "<br>" + "getPreferBinId : " + getPreferBinId + "<br>" + "strLocation : " + strLocation + "<br>";
    ...
    if (strLocation != null && strLocation != '') filterStrat.push(new nlobjSearchFilter('location', null, 'anyof', strLocation));
    ...
    if (objBinDetails != null && objBinDetails != '') {
        ...
        for (var j = 0; j < objBinDetails.length; j++) {
            ...
            if (vValidBin != null && vValidBin != '' && vValidBin != getPreferBin && vBinLocArr.indexOf(vValidBin) == -1 && vBinLocArr.length < 5) vBinLocArr.push(vValidBin);
...
function fnGetYetToBePicked(getItemInternalId, vBinDetails, strLocation, VUnitType, blnItemUnit) {
    ...
    var ctx = nlapiGetContext();
    if (ctx != null && ctx != '') {
        if (ctx.getFeature('pickpackship').toString() != null && ctx.getFeature('pickpackship').toString() != '') ShipCheckFlag = ctx.getFeature('pickpackship');
    ...
    if (ShipCheckFlag == true) {
        ...
        if (strLocation != null && strLocation != '' && strLocation != 'undefined' && strLocation != 'null') filters.push(new nlobjSearchFilter('location', null, 'anyof', ['@NONE@', strLocation]));
        ...
        if (OrderDetails != null && OrderDetails != '' && OrderDetails != 'null' && OrderDetails != 'undefined' && OrderDetails.length > 0) {
            // nlapiLogExecution('Debug', 'OrderDetails.length',
            // OrderDetails.length);
        ...
        if (OrderDetails != null && OrderDetails != '' && OrderDetails != 'null' && OrderDetails != 'undefined' && OrderDetails.length > 0) {
            // nlapiLogExecution('ERROR', 'OrderDetails.length',
            // OrderDetails.length);
            for (var j = 0; j < OrderDetails.length; j++) {
    ...
    if (vOpenBinQty == null || vOpenBinQty == '' || vOpenBinQty == 'null' || vOpenBinQty == 'undefined') vOpenBinQty = 0;

    if (CommittedQty == null || CommittedQty == '' || CommittedQty == 'null' || CommittedQty == 'undefined') CommittedQty = 0;
    ...
    if (strLocation != null && strLocation != '' && strLocation != 'undefined' && strLocation != 'null') filtersback.push(new nlobjSearchFilter('location', null, 'anyof', ['@NONE@', strLocation]));

    var BackorderdQtyDets = new nlapiSearchRecord('transaction', 'customsearch_wmsse_backorder_qty_det', filtersback, columnsback); //
    if (BackorderdQtyDets != null && BackorderdQtyDets != '' && BackorderdQtyDets != 'null' && BackorderdQtyDets != 'undefined' && BackorderdQtyDets.length > 0) {
    ...
    if (finalYetToBePicked > 0) PickedBackOrd.push(finalYetToBePicked);
    else PickedBackOrd.push(0);
    if (BackorderdQty > 0) PickedBackOrd.push(BackorderdQty);
    else PickedBackOrd.push(0);
...
function nswms_GetPreferredBinType(Binnumber, whLocation, Item) {
    ...
    var filter = new Array();
    if (Binnumber != null && Binnumber != '' && Binnumber != 'null' && Binnumber != 'undefined') filter.push(new nlobjSearchFilter('binnumber', null, 'is', Binnumber));
    filter.push(new nlobjSearchFilter('inactive', null, 'is', 'F'));
    if (whLocation != null && whLocation != '' && whLocation != 'null' && whLocation != 'undefined') filter.push(new nlobjSearchFilter('location', null, 'anyof', whLocation));
    var columns = new Array();
    ...
    if (searchrecord != null && searchrecord != "") {
        ...
        if (vLocationType != 'WIP') preferredbintype = searchrecord[0].getText('custrecord_wmsse_bin_loc_type');
    }
