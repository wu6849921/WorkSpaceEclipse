...
function RFFulfillmentMenu(request, response){
	if (request.getMethod() == 'GET') {
		...
		//var checkInURL_1 = nlapiResolveURL('SUITELET', 'customscript_wmsse_pickreportno_scan', 'customdeploy_wmsse_pickreportno_scan');
		...
		//var checkInURL_2 = nlapiResolveURL('SUITELET', 'customscript_wmsse_pickreportno_scan', 'customdeploy_wmsse_pickreportno_scan');
