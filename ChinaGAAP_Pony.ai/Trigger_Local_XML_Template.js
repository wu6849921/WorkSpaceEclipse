...
trigger.local.xmltemplate.prototype = {
	...
	GetProfitXML : function(profit, name) {
		...
		xml += String
				.format(
						"<tr><th>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;资产减值损失</th><th>7</th><td>{0}</td><td>{1}</td></tr>",
						com.formatCurrency(profit.monthassetsimpairmentloss),
						com.formatCurrency(profit.assetsimpairmentloss));
		xml += String
				.format(
						"<tr><th>&nbsp;&nbsp;加： 公允价值变动收益 （损失以“-”号列示）</th><th>8</th><td>{0}</td><td>{1}</td></tr>",
						com.formatCurrency(profit.monthgainsonthechanges), com
								.formatCurrency(profit.gainsonthechanges));
		xml += String
				.format(
						"<tr><th>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;投资收益（损失以“－”号填列）</th><th>9</th><td>{0}</td><td>{1}</td></tr>",
		...
		xml += String
				.format(
						"<tr><th class='bgcolor'>二、营业利润（亏损以“－”号填列）</th><th>11</th><td>{0}</td><td>{1}</td></tr>",
						com.formatCurrency(profit.monthoperatingprofit), com
								.formatCurrency(profit.operatingprofit));
		xml += String
				.format(
						"<tr><th>&nbsp;&nbsp;加：营业外收入</th><th>12</th><td>{0}</td><td>{1}</td></tr>",
		...
		xml += String
				.format(
						"<tr><th>&nbsp;&nbsp;减：营业外支出</th><th>14</th><td>{0}</td><td>{1}</td></tr>",
						com.formatCurrency(profit.monthoutsidecost), com
								.formatCurrency(profit.outsidecost));
		xml += "<tr><th>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;其中：非流动资产处置损失</th><th>15</th><td>0.00</td><td>0.00</td></tr>"; // 15
																															// end
		xml += String
				.format(
						"<tr><th class='bgcolor'>三、利润总额（亏损以“－”号填列）</th><th>16</th><td>{0}</td><td>{1}</td></tr>",
						com.formatCurrency(profit.monthtotalprofit), com
								.formatCurrency(profit.totalprofit));
		xml += String
				.format(
						"<tr><th>&nbsp;&nbsp;减：所得税费用</th><th>17</th><td>{0}</td><td>{1}</td></tr>",
						com.formatCurrency(profit.monthtax), com
								.formatCurrency(profit.tax));
		xml += String
				.format(
						"<tr><th class='bgcolor'>四、净利润（亏损以“－”号填列）</th><th>18</th><td>{0}</td><td>{1}</td></tr>",
	...
	GetBalanceSheetXML : function(bs, name) {
		...
		xml += "<th>2</th> ";
		xml += String.format("<td>{0}</td>", com
				.formatCurrency(bs.TradingFinancialAssets));
		xml += String.format("<td>{0}</td>", com
				.formatCurrency(bs.TradingFinancialAssetsEnd));
		xml += "<th>交易性金融负债</th>";
		xml += "<th>2</th> ";
		xml += String.format("<td>{0}</td>", com
				.formatCurrency(bs.TradingFinancialLiabilities));
		xml += String.format("<td>{0}</td>", com
				.formatCurrency(bs.TradingFinancialLiabilitiesEnd));
		xml += "</tr>";
		xml += "<tr>";
		xml += "<th>应收票据</th>";
		xml += "<th>3</th>";
		...
		xml += "<th>8</th>";
		xml += String.format("<td>{0}</td>", com
				.formatCurrency(bs.InterestPayable));
		xml += String.format("<td>{0}</td>", com
				.formatCurrency(bs.InterestPayableEnd));
		xml += "</tr>";
		xml += "<tr>";
		xml += "<th>存货</th>";
		xml += "<th>9</th> ";
		...
		xml += "<th>10</th>";
		xml += String.format("<td>{0}</td>", com
				.formatCurrency(bs.NonCurrentAssetsMaturedWithinAYear));
		xml += String.format("<td>{0}</td>", com
				.formatCurrency(bs.NonCurrentAssetsMaturedWithinAYearEnd));
		xml += "<th>其他应付款</th>";
		xml += "<th>10</th>";
		xml += String.format("<td>{0}</td>", com
		...
		xml += "<th>14</th> ";
		xml += String.format("<td>{0}</td>", com
				.formatCurrency(bs.AvailableForSaleFinancialAssets));
		xml += String.format("<td>{0}</td>", com
				.formatCurrency(bs.AvailableForSaleFinancialAssetsEnd));
		...
		xml += "<th>15</th>";
		xml += String.format("<td>{0}</td>", com
				.formatCurrency(bs.HeldToMaturityInvestment));
		xml += String.format("<td>{0}</td>", com
				.formatCurrency(bs.HeldToMaturityInvestmentEnd));
		xml += "<th>长期借款</th>";
		xml += "<th>15</th> ";
		xml += String.format("<td>{0}</td>", com
		...
		xml += "<th>16</th>";
		xml += String.format("<td>{0}</td>", com
				.formatCurrency(bs.LongTermReceivables));
		xml += String.format("<td>{0}</td>", com
				.formatCurrency(bs.LongTermReceivablesEnd));
		xml += "<th>应付债券</th>";
		xml += "<th>16</th>";
		xml += String.format("<td>{0}</td>", com
		...
		xml += "<th>18</th>";
		xml += String.format("<td>{0}</td>", com
				.formatCurrency(bs.InvestmentRealEstate));
		xml += String.format("<td>{0}</td>", com
				.formatCurrency(bs.InvestmentRealEstateEnd));
		xml += "<th>专项应付款</th>";
		xml += "<th>18</th>";
		xml += "<td></td>";
		xml += "<td></td>";
		...
		xml += "<th>19</th> ";
		xml += String
				.format("<td>{0}</td>", com.formatCurrency(bs.FixedAssets));
		xml += String.format("<td>{0}</td>", com
				.formatCurrency(bs.FixedAssetsEnd));
		xml += "<th>预计负债</th>";
		xml += "<th>19</th>";
		xml += String.format("<td>{0}</td>", com
		...
		xml += "<th>21</th>";
		xml += String.format("<td>{0}</td>", com
				.formatCurrency(bs.OtherNonCurrentLiabilities));
		xml += String.format("<td>{0}</td>", com
				.formatCurrency(bs.OtherNonCurrentLiabilitiesEnd));
		xml += "</tr>";
		xml += "<tr>";
		xml += "<th> 固定资产清理</th>";
		xml += "<th>22</th>";
		...
		xml += String.format("<td>{0}</td>", com
				.formatCurrency(bs.TotalNonCurrentLiabilitiesEnd));
		xml += "</tr>";
		xml += "<tr>";
		xml += "<th>生产性生物资产</th>";
		xml += "<th>23</th> ";
		xml += String.format("<td>{0}</td>", com
				.formatCurrency(bs.ProductiveBiologicalAsset));
		xml += String.format("<td>{0}</td>", com
				.formatCurrency(bs.ProductiveBiologicalAssetEnd));
		...
		xml += "<th>24</th>";
		xml += String.format("<td>{0}</td>", com
				.formatCurrency(bs.OilAndGasAssets));
		xml += String.format("<td>{0}</td>", com
				.formatCurrency(bs.OilAndGasAssetsEnd));
		...
		xml += "<th>26</th>";
		xml += String.format("<td>{0}</td>", com
				.formatCurrency(bs.DevelopmentExpediture));
		xml += String.format("<td>{0}</td>", com
				.formatCurrency(bs.DevelopmentExpeditureEnd));
		xml += "<th>资本公积</th>";
		xml += "<th>26</th>";
		xml += String.format("<td>{0}</td>", com
		...
		xml += "<th>27</th>";
		xml += String.format("<td>{0}</td>", com
				.formatCurrency(bs.BusinessReputation));
		xml += String.format("<td>{0}</td>", com
				.formatCurrency(bs.BusinessReputationEnd));
		xml += "<th>减：库存股</th>";
		xml += "<th>27</th> ";
		xml += String.format("<td>{0}</td>", com
				.formatCurrency(bs.SubtractionTreasuryStock));
		xml += String.format("<td>{0}</td>", com
				.formatCurrency(bs.SubtractionTreasuryStockEnd));
		xml += "</tr>";
		xml += "<tr>";
		xml += "<th>长期待摊费用</th>";
		xml += "<th>28</th> ";
		...
		xml += "<th>29</th>";
		xml += String.format("<td>{0}</td>", com
				.formatCurrency(bs.DeferredIncomeTaxAssets));
		xml += String.format("<td>{0}</td>", com
				.formatCurrency(bs.DeferredIncomeTaxAssetsEnd));
		xml += "<th>未分配利润</th>";
		xml += "<th>29</th> ";
		xml += String.format("<td>{0}</td>", com
		...
		xml += "<th>30</th>";
		xml += String.format("<td>{0}</td>", com
				.formatCurrency(bs.OtherNonCurrentAssets));
		xml += String.format("<td>{0}</td>", com
				.formatCurrency(bs.OtherNonCurrentAssetsEnd));
		...
		xml += String.format("<td>{0}</td>", com
				.formatCurrency(bs.TotalNonCurrentAssetsEnd));
		xml += "<th></th>";
		xml += "<th>31</th>";
		xml += "<td></td>";
		xml += "<td></td>";
	...
	GetDiaryLedgerXMLHead : "<?xml version='1.0' encoding='UTF-8'?>\n"
			...
			+ "#header{align:center}" + "#txtright{align:right}"
			+ "#main{width:523pt;font-size:8pt;}"
			+ "#main th{font:10pt;border:0.2pt;padding:0px 2px;word-wrap:break-word;}"
			+ "#main td{align:right;border:0.2pt;color:blue;}"
			+ "#col1 {width:25pt;}"
			+ "#col2 {valign:middle;align:center;}"
			+ "#col3 {valign:middle;align:center;}"
			+ "#col4 {valign:middle;align:center;}"
			+ "#col5 {valign:middle;align:center;}"
			+ "#col6 {valign:middle;align:center;}"
			+ "#col7 {valign:middle;align:center;}"
