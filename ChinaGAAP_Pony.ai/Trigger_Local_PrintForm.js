...
trigger.local.printform.prototype = {
	...
	main : function(request, response) {
		...
		// print Excel add by joe 20190306
		var printExcelCx = form.addField('custpage_printexcel', 'checkbox',
				null, null, 'triggergroup');
		var printExcelLe = classlang.UIPrintExcel(lang);
		printExcelCx.setLabel(printExcelLe);
	...
	returnParameters : function() {
		...
		// print excel条件 add by joe 20190306
		var printEx = nlapiGetFieldValue('custpage_printexcel');// F|T
		var temp = '';
		...
		temp += String.format("&PRINTEXCEL={0}", printEx);
		return temp;
