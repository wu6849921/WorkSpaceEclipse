 ...
 */
define(['../../dao/cn_blsheet_acc_period_dao', '../../dao/cn_subsidiary_dao', '../../lib/wrapper/ns_wrapper_ui_serverWidget', '../helper/serverWidget_helper', '../../lib/commons', '../../lib/wrapper/ns_wrapper_record', '../../lib/wrapper/ns_wrapper_runtime', '../../res/cashflow/cashflowresource', '../../app/cashflow/app_cn_cashflow_period_init', '../../app/balance_sheet/app_cn_blsheet_location_init', '../../app/balance_sheet/app_cn_blsheet_department_init', '../../app/balance_sheet/app_cn_blsheet_class_init','N/search'],
function(periodDAO, subsidiaryDAO, serverWidget, helper, commons, record, runtime, resource, period_init, location_init, department_init, class_init,search) {
    ...
    function addInlineHTMLArea(form) {
        ...
        var div = ["<div id='divvat' name='divvat' style='border-top: 0px dotted #000000; margin-top:5px;" + divStyle + "'>"];
    ...
    function fetchSubsidiariesAsDropdown() {
        ...
        for (var subIdx in originresults) {
            try {
                var subsidiaryId = originresults[subIdx].id;
...
// if (originresults[subIdx].id == '2' || originresults[subIdx].id == '13' ||
// originresults[subIdx].id == '7' || originresults[subIdx].id == '8' ||
// originresults[subIdx].id == '9' || originresults[subIdx].id == '10') {
                    record.load({
...
// }
    ...
    function cacheInfor(form) {
        ...
        var cacheInfo = {
            messageInfo: labels,
            // labels信息
            cashflow_fileNamePrefix: fileNamePrefix,
            // 文件名前缀Cash Flow Statement
