...
define([ '../../lib/wrapper/ns_wrapper_search',
		...
		'../../dao/helper/search_helper', '../../lib/commons' ], function(
		search, record, helper, commons) {
	/**
	 * @desc fetch all subsidiaries with parameters.
	 * @param {object}
	 *            [params] - subsidiary parameters.
	 ...
	 * @param {object}
	 *            [params] - parameters which used to filter.
	 ...
	 * @param {object}
	 *            [params] - parameters which used check if calendar enable or
	 *            not.
