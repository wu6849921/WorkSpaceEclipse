				...
				try {
					if (context.type == context.UserEventType.EDIT
						...
						for (var i = 0; i < lineCount; i++) {
							...
							// 算出priceQuoteBase的值
							// var priceQuoteBase = priceQuote / factor;
							setSublistValue(newRecord, 'item',
