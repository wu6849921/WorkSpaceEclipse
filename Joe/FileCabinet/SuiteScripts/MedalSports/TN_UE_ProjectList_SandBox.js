				...
				try {
					if (context.type == context.UserEventType.EDIT
						...
						for (var i = 0; i < lineCount; i++) {
							...
							// 20181015 joe
							var storageCostBase = newRecord.getSublistValue({
								sublistId : 'item',
								fieldId : 'custcol_tn_storagecostbase',
								line : i
							});
							var storageCost = storageCostBase * storeperiod;
							setSublistValue(newRecord, 'item',
							...
							setSublistValue(newRecord, 'item',
									...
									priceQuote);
							// priceQuote需要*factor 20181015 joe
							var priceQuoteBase = priceQuote;
							...
							var ppfpAmt = priceQuoteBase * ppfp;
							setSublistValue(newRecord, 'item',
							...
							var programAmt = priceQuoteBase * program;
							setSublistValue(newRecord, 'item',
									'custcol_tn_quote_vendtermamt', i,
									programAmt);

							// var paymentTermAmt = priceQuote * paymentTerm;
							var paymentTermAmt = priceQuoteBase * paymentTerm;
							setSublistValue(newRecord, 'item',
									'custcol_tn_quote_termamt', i,
									paymentTermAmt);

							var storeDefectiveAllowanceAmt = priceQuoteBase
							...
							if (incoterm != '11' && incoterm != '12') {
								...
								setSublistValue(newRecord, 'item',
										...
										totalStoreCost);
								// totalStoreCost需要*factor 20181015 joe
								totalStoreCost = totalStoreCost * factor;
								setSublistValue(newRecord, 'item',
						...
						if (context.type == context.UserEventType.CREATE) {
							for (var i = 0; i < lineCount; i++) {
								...
								var _item = newRecord.getSublistValue({
									sublistId : 'item',
									fieldId : 'item',
									line : i
								});
								var _displayName = newRecord.getSublistValue({
									sublistId : 'item',
									fieldId : 'custcol_tn_opp_display_name',
									line : i
								});
								...
								var itmPlRecord = record.create({
									type : 'customrecord_tn_itempl'
								});
								itmPlRecord.setValue({
									fieldId : 'custrecord_tn_projectlist',
									value : newRecord.id
								});
								itmPlRecord.setValue({
									fieldId : 'custrecord_tn_items_itemline',
									value : _line
								});
								itmPlRecord.setValue({
									fieldId : 'custrecord_tn_items_item',
									value : _item
								});
								itmPlRecord.setValue({
									fieldId : 'custrecord_tn_items_disname',
									value : _displayName
								});
								itmPlRecord
										.setValue({
											fieldId : 'custrecord_tn_items_mdstifaccost',
											value : estimitfcost
										});
								itmPlRecord.save();
							}
