	...
	function pageInit(context) {
		try {
			...
			for (var i = 0; i < numLines; i++) {
				...
				var customerPOC = soRec.getSublistValue({
					sublistId : 'item',
				...
				var esd = soRec.getSublistValue({
					sublistId : 'item',
					fieldId : 'custcol_tn_po_esd',
					line : i
				});
				var lsd = soRec.getSublistValue({
					sublistId : 'item',
					fieldId : 'custcol_tn_po_lsd',
					line : i
				});
				var itd = soRec.getSublistValue({
					sublistId : 'item',
					fieldId : 'custcol_tn_po_itd',
					line : i
				});
				var shipdes = soRec.getSublistValue({
					sublistId : 'item',
			...
			for (var i = 0; i < numLinesPo; i++) {
				var esd = currentRecord.getSublistValue({
					sublistId : 'item',
					fieldId : 'custcol_tn_po_esd',
					line : i
				});
				var lsd = currentRecord.getSublistValue({
					sublistId : 'item',
					fieldId : 'custcol_tn_po_lsd',
					line : i
				});
				var itd = currentRecord.getSublistValue({
					sublistId : 'item',
					fieldId : 'custcol_tn_po_itd',
					line : i
				});
				var customerpo = currentRecord.getSublistValue({
					sublistId : 'item',
					fieldId : 'custcol_tn_line_customerpo',
					line : i
				});
				var shipdespo = currentRecord.getSublistValue({
					sublistId : 'item',
					fieldId : 'custcol_tn_quote_shipdes',
					line : i
				});
