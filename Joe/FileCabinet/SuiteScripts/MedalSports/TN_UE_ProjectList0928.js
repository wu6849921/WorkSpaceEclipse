					...
					if (context.type == context.UserEventType.EDIT
						...
						for (var i = 0; i < lineCount; i++) {
							...
							case '4':// DDP
								...
								landedCost = FOBQuotePrice + freightAmount
										+ dutyAmount + gstAmount;
								// log.debug({
								// title : 'landedCost2',
							...
							case '8':// Warehouse_Collect
								...
								gstAmount = gstper * FOBQuotePrice;
								landedCost = FOBQuotePrice + freightAmount
										+ dutyAmount + whseHandling
										+ inbundcharge + storecost
										+ outbundcharge + paletcost + gstAmount;
								priceQuote = landedCost
										/ (1 - (program + paymentTerm + storeDefectiveAllowance));
								programAmount = program * priceQuote;
								paymentTermAmt = paymentTerm * priceQuote;
							...
							case '6':// Warehouse_Prepaid
								...
								landedCost = FOBQuotePrice + freightAmount
										+ dutyAmount + whseHandling
										+ inbundcharge + storecost
										+ outbundcharge + paletcost
										+ freightToCustomer + gstAmount;
								// log.debug({
								// title : 'landedCost',
								// details : FOBQuotePrice + '|'
								// + freightAmount + '|' + dutyAmount
							...
							case '11':// Drop Ship_Collect
								...
								landedCost = mdEstimateFactoryCost + PLIAmount
										+ afterServiceAmount
										+ defectiveAllowanceAmount
										+ testingFeeAmount + reserveAmount
										+ freightAmount + dutyAmount
										+ inbundcharge + storecost
										+ outbundcharge + gstAmount
										+ otherExpenseAmt + markdownAmt;
							...
							switch (incoterm) {
							case '3':
								totalCost = mdEstimateFactoryCost
										+ salesCommAmt + pliAmt
										+ afterServiceAmt + mdAllowanceAmt
										+ testingFreeAmt + reserveAmt
										+ otherExpenseAmt + royalityAmt
										+ markdownAmt + lclAmt + ppfpAmt;
								// log.debug({
								// title : 'totalCost',
								// details : mdEstimateFactoryCost + '|'
								// + salesCommAmt + '|' + pliAmt + '|'
							...
							case '11':
								totalCost = landedCost + salesCommAmt
										+ royalityAmt + programAmt
										+ paymentTermAmt
										+ storeDefectiveAllowanceAmt + ppfpAmt;
								break;
