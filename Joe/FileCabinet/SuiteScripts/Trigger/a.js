 ...
 */
define(
		[ 'N/search', 'N/record', 'N/email', 'N/runtime', 'N/error' ],
		function(search, record, email, runtime, error) {
			function handleErrorAndSendNotification(e, stage) {
				...
				var subject = 'Map/Reduce script '
						+ runtime.getCurrentScript().id + ' failed for stage: '
						+ stage;
			...
			function handleErrorInStage(stage, summary) {
				...
				summary.errors
						...
						.each(
								function(key, value) {
									var msg = 'Failure to accept payment from customer id: '
											+ key
											+ '. Error was: '
			...
			function applyLocationDiscountToInvoice(recordId) {
				...
				log.debug(recordId
						+ ' has been updated with location-based discount.');
				invoice.save();
			}
