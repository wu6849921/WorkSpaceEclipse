...
trigger.local.balancesheet.prototype = {
	writeBalanceSheetToPDF : function(subsidiaryid, subsidiaryname, periodid,
		...
		bs.Cash = parseFloat(n1001[1]) - parseFloat(n1001[0])
				...
				+ parseFloat(n1012[1]) - parseFloat(n1012[0]);
		...
		bs.NetReceivable = parseFloat(n1122[1]) - parseFloat(n1122[0])
				+ parseFloat(n1231[1]) - parseFloat(n1231[0]);
		...
		bs.NetReceivableEnd = parseFloat(n1122[1]) - parseFloat(n1122[0])
				+ parseFloat(n1231[1]) - parseFloat(n1231[0]);
		...
		bs.AvailableForSaleFinancialAssets = parseFloat(n1503[1])
				- parseFloat(n1503[0]);
		n1503 = endmap.GetValue('1503').name;
		if (!n1503) {
			n1503 = [ 0, 0 ];
		}
		bs.AvailableForSaleFinancialAssetsEnd = parseFloat(n1503[1])
				- parseFloat(n1503[0]);
		...
		bs.HeldToMaturityInvestment = parseFloat(n1501[1])
				- parseFloat(n1501[0]) - parseFloat(n1502[1])
				- parseFloat(n1502[0]);
		...
		bs.HeldToMaturityInvestmentEnd = parseFloat(n1501[1])
				- parseFloat(n1501[0]) - parseFloat(n1502[1])
				- parseFloat(n1502[0]);
		...
		bs.LongTermReceivables = parseFloat(n1531[1]) - parseFloat(n1531[0])
				+ parseFloat(n1532[1]) - parseFloat(n1532[0]);
		...
		bs.LongTermReceivablesEnd = parseFloat(n1531[1]) - parseFloat(n1531[0])
				+ parseFloat(n1532[1]) - parseFloat(n1532[0]);
		...
		bs.longTermEquityInvestment = parseFloat(n1511[1])
				- parseFloat(n1511[0]) - parseFloat(n1512[1])
				- parseFloat(n1512[0]);
		...
		bs.longTermEquityInvestmentEnd = parseFloat(n1511[1])
				- parseFloat(n1511[0]) - parseFloat(n1512[1])
				- parseFloat(n1512[0]);
		...
		bs.InvestmentRealEstateEnd = parseFloat(n1521[1])
				- parseFloat(n1521[0]);
		...
		bs.FixedAssets = parseFloat(n1601[1]) - parseFloat(n1601[0])
				+ parseFloat(n1602[1]) - parseFloat(n1602[0])
				+ parseFloat(n1603[1]) - parseFloat(n1603[0]);
		...
		bs.FixedAssetsEnd = parseFloat(n1601[1]) - parseFloat(n1601[0])
				+ parseFloat(n1602[1]) - parseFloat(n1602[0])
				+ parseFloat(n1603[1]) - parseFloat(n1603[0]);
		...
		bs.ConstructionInProgressEnd = parseFloat(n1604[1])
				- parseFloat(n1604[0]);
		...
		bs.ProductiveBiologicalAsset = parseFloat(n1621[1])
				- parseFloat(n1621[0]) - parseFloat(n1622[1])
				- parseFloat(n1622[0]);
		...
		bs.ProductiveBiologicalAssetEnd = parseFloat(n1621[1])
				- parseFloat(n1621[0]) - parseFloat(n1622[1])
				- parseFloat(n1622[0]);
		// 油气资产
		...
		bs.OilAndGasAssets = parseFloat(n1631[1]) - parseFloat(n1631[0])
				- parseFloat(n1632[1]) - parseFloat(n1632[0]);
		...
		bs.OilAndGasAssetsEnd = parseFloat(n1631[1]) - parseFloat(n1631[0])
				- parseFloat(n1632[1]) - parseFloat(n1632[0]);
		// 无形资产
		...
		bs.IntangibleAssets = parseFloat(n1701[1]) - parseFloat(n1701[0])
				+ parseFloat(n1702[1]) - parseFloat(n1702[0])
				+ parseFloat(n1703[1]) - parseFloat(n1703[0]);
		...
		bs.IntangibleAssetsEnd = parseFloat(n1701[1]) - parseFloat(n1701[0])
				+ parseFloat(n1702[1]) - parseFloat(n1702[0])
				+ parseFloat(n1703[1]) - parseFloat(n1703[0]);
		...
		bs.DevelopmentExpeditureEnd = parseFloat(n5301[1])
				- parseFloat(n5301[0]);
		...
		bs.LongTermUnamortizedExpenses = parseFloat(n1801[1])
				- parseFloat(n1801[0]);
		n1801 = endmap.GetValue('1801').name;
		if (!n1801) {
			n1801 = [ 0, 0 ];
		}
		bs.LongTermUnamortizedExpensesEnd = parseFloat(n1801[1])
				- parseFloat(n1801[0]);
		...
		bs.DeferredIncomeTaxAssets = parseFloat(n1811[1])
				- parseFloat(n1811[0]);
		n1811 = endmap.GetValue('1811').name;
		if (!n1811) {
			n1811 = [ 0, 0 ];
		}
		bs.DeferredIncomeTaxAssetsEnd = parseFloat(n1811[1])
				- parseFloat(n1811[0]);
		...
		bs.OtherNonCurrentAssetsEnd = parseFloat(n1623[1])
				- parseFloat(n1623[0]);
		...
		for (var i = 0; i < notconfirmmap.Count; i++) {
			...
			// nlapiLogExecution('debug', 'OtherCreditors'+specialid,
			// specialvalue);
		}
		for (var i = 0; i < notconfirmendmap.Count; i++) {
			var specialid = notconfirmendmap.ArrayList[i];
			...
			// nlapiLogExecution('debug', 'OtherCreditorsEnd'+specialid,
			// specialvalue);
		}
		 ...
		 * nlapiLogExecution('debug', 'TradingFinancialLiabilities',
		 * bs.TradingFinancialLiabilities); nlapiLogExecution('debug',
		 * 'NotesPayable', bs.NotesPayable); nlapiLogExecution('debug',
		 * 'AccountsPayable', bs.AccountsPayable); nlapiLogExecution('debug',
		 * 'AdvancesFromCustomers', bs.AdvancesFromCustomers);
		 ...
		 * nlapiLogExecution('debug', 'OtherCurrentLiabilities',
		...
		bs.longTermAccountsPayable = 0
				- (parseFloat(n2701[1]) - parseFloat(n2701[0]))
				- (parseFloat(n2702[1]) - parseFloat(n2702[0]));
		...
		bs.longTermAccountsPayableEnd = 0
				- (parseFloat(n2701[1]) - parseFloat(n2701[0]))
				- (parseFloat(n2702[1]) - parseFloat(n2702[0]));
		...
		// 负债合计
		bs.TotalLongTermLiabilities = parseFloat(bs.TotalCurrentLiabilities)
				+ parseFloat(bs.TotalNonCurrentLiabilities);
		bs.TotalLongTermLiabilities = parseFloat(bs.TotalLongTermLiabilities)
				.toFixed(2);
		bs.TotalLongTermLiabilitiesEnd = parseFloat(bs.TotalCurrentLiabilitiesEnd)
				+ parseFloat(bs.TotalNonCurrentLiabilitiesEnd);
		...
		// 未分配利润
		// 4104 + 4103 +
		// [6001,6401,6403,6051,6601,6602,6603,6701,6101,6111,6301,6711,6801];
		var ntotal6000 = 0;
		var ntotal6001 = 0;
		...
		// 负债和所有者权益（或股东权益）总计
		bs.TotalLiabilitiesEquity = parseFloat(bs.TotalLongTermLiabilities)
				+ parseFloat(bs.TotalShareholdersEquity);
		bs.TotalLiabilitiesEquityEnd = parseFloat(bs.TotalLongTermLiabilitiesEnd)
