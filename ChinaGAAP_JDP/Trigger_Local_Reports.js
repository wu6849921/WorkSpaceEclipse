 ...
 * 
 * 
 * 新增saved search customsearch_trigger_pl_trial_blnc_2
 * 修改saved search customsearch_trigger_mapping_cn_coa
 * 
 * 修改saved search customsearch_trigger_balance_sheet
 * 
 */
...
function main(request, response) {
	...
	// joe
	case 'TRIALBALANCE1':
		var o = new trigger.local.trialbalance1();
		o.writeTrialBalanceToPDF1(subsidiaryid, periodid, period, response);
		break;
	case 'TRIALBALANCE2':
		var o = new trigger.local.trialbalance2();
		o.writeTrialBalanceToPDF2(subsidiaryid, periodid, period, response);
		break;
	case 'BALANCESHEET':
